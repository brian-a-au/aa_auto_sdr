...
[![Tests](https://img.shields.io/badge/tests-1807-brightgreen.svg)](tests/)
...
| Notion publishing ([setup](docs/CLI_REFERENCE.md#notion-integration)) | `aa_auto_sdr <RSID> --format notion` |
